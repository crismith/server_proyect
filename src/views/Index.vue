<template>
  <section class="section-services">
    <div class="container-services">
      <div
        class="card-service card mb-3 ml-2 mr-2"
      ...
      >
        <div class="card-body body-service">
          ...
          <div class="d-flex justify-content-around info-service mt-2 pb-2">
            <div
              class="data-hour-week d-flex flex-column justify-content-center"
            >
              <strong class="number">
                321 ms
              </strong>
...
export default {
  ...
  methods: {
    getServices() {
      ...
      this.axios
        .get("http://localhost:8081/api/services?pageSize=12&page=0", {
          headers: {
            Authorization: token,
...
.section-services {
  .container-services {
    .card-service {
      box-shadow: 0 2px 1px -1px rgb(0, 0, 0, 0.2),
        0 1px 1px 0 rgb(0, 0, 0, 0.14), 0 1px 3px 0 rgb(0, 0, 0, 0.12);
      .body-service {
        .name-service {
          margin: 0;
          .url-service {
